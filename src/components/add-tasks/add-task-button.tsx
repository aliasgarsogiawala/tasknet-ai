...
export const AddTaskWrapper = () => {
    ...
    return showAddTask ? (<AddTaskInline setShowAddTask={setShowAddTask} /> )
...
export default function AddTaskButton({ onClick }: AddTaskButtonProps){
    return (
    <button className="pl-2 flex mt2 flex-1" onClick={onClick}>
        <div className="flex flex-col items-center justify-center gap-1 text-center">
            <div className="flex items-center gap-2 justify-center">
            <Plus className="h-4 w-4 text-primary hover:bg-primary hover:rounded-xl 
            hover:text-white " />
